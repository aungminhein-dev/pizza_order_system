    ...
    <div class="container-fluid">
        <div class="">
            ...
            <div class="container-md ">
               <div class="row">
                    <div class="col-6 offset-1 mb-4 d-flex">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary "><i class="fa-solid fa-magnifying-glass d-inline-block"></i></button>
                    </form>
                    </div>
                  <div class="col-2">
                    <button class=" btn btn-sm bg-dark text-white">Total Requests - {{ $pendings->total()}}</button>
                  </div>
               </div>
                ...
                <div class="col-12 col-lg-10">
                    <div class="table-responsive table-responsive-data2">
                        <table class="table table-data2">
                            ...
                            <tbody id="table">
                                @foreach ($pendings as $o)

                                    <tr class="tr-shadow pe-2">
                                        <input type="hidden" class="orderId" value="{{$o->id}}">
                                        <td class="align-middle">{{ $o->user_name }}</td>
                                        <td class="text-primary align-middle"><a href="{{route('order#details',$o->order_code)}}">{{ $o->order_code }}</a></td>
                        ...
                        <div class="mt-2">
                        {{ $pendings->appends(request()->query())->links() }}
                    </div>
                    </div>
            ...
            <div class="row">
                <div class=""></div>
                <div class="col-6">
                    <img style="width:350px" src="{{asset('admin/img/inbox-zero.png')}}" alt="">
                </div>
                <div class="col-3">
